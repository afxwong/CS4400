-- CS4400: Introduction to Database Systems: Sunday, April 3, 2022
-- One-to-One SQL Assessment [AUTOGRADER (v2)]: Global Company Database
...
create or replace view practiceQuery209 as
select company, location, assets
from customer
where (location = "Dallas" or location = "Houston") and (assets is null or assets > 500000);

create or replace view practiceQuery361 as
select location, sum(assets) as total_assets, count(*) as num_identifiers
from customer
group by location
order by location;

create view practiceQuery616 as 
select fname, lname, ip_address, user_account, duration
from employee, remote_access, time_frames
where employee.ssn = remote_access.ssn and start_hour + duration < 24 and time_frames.ssn = employee.ssn;

create view practiceQuery813 as
select project.pnumber, pname, remaining, usage_rate
from project
right join fund_source
on project.pnumber = fund_source.pnumber
where project.pnumber in (3, 10, 20)
order by pname;

create view practiceQuery738 as 
select pname, pnumber, plocation
from project
where project.pnumber in (select pnumber from operations) and project.pnumber in (select pnumber from maintenance);
...
(0,209,'power,water&copper#dallas#############'),
(0,209,'#houston#850000############'),
(0,227,'bank2#tempestbank#atlanta#200000###########'),
(0,227,'bank3#creditunionuniversal#newyork#417000###########'),
(0,227,'mgmt1#power,water&copper#dallas############'),
(0,227,'tech2#cumuluscloudcomputing##380000###########'),
(0,227,'tech3##houston#850000###########'),
...
(0,350,'10#vpn#1600############'),
(0,350,'10#open#2000############'),
(0,355,'123456789#3#1988-12-30############'),
(0,355,'333445555#3#1986-04-04############'),
(0,355,'987654321#1#1942-02-28############'),
(0,361,'#380000#1############'),
...
(0,409,'20#3#25.0############'),
(0,409,'30#3#55.0############'),
(0,441,'123456789#alice#7#1###########'),
(0,441,'123456789#michael#6#2###########'),
(0,441,'333445555#alice#10#0###########'),
(0,500,'john#smith#123456789#michael#731fondren,houstontx#m#########'),
(0,500,'franklin#wong#333445555#theodore#638voss,houstontx#m#########'),
(0,515,'administration#6#64000############'),
(0,515,'headquarters#10#170000#31000#2000##########'),
(0,515,'research#0#516000#61000#5000##########'),
...
(0,616,'ramesh#narayan#403e:8f59:336e:d11b:0425:ed18:2f34:48a3#rnarayan3#9##########'),
(0,616,'james#borg#26c8:4186:2105:cf66:7b3f:4b03:5dd7:3eb4#jborg1#4##########'),
(0,616,'jennifer#wallace#3208:78e4:578b:034b:c7ff:1b55:6e41:8ece#jwallace3#4##########'),
(0,622,'3#27000#1000############'),
...
(0,647,'newbenefits##############'),
(0,650,'producty#2#sugarland#5###########'),
(0,650,'computerization#10#stafford#4###########'),
(0,650,'newbenefits#30#stafford#4###########'),
(0,676,'computerization#10#stafford############'),
(0,676,'reorganization#20#houston############'),
(0,689,'bank1#secondnationalbank#350000############'),
(0,689,'tech2#cumuluscloudcomputing#380000############'),
(0,689,'tech3##850000############'),
(0,689,'bank3#creditunionuniversal#417000############'),
(0,701,'2#stockmarketprediction#############'),
(0,701,'10#dronetrafficcontrol#############'),
(0,701,'20#cloudconversion#############'),
(0,710,'headquarters#1#888665555############'),
(0,710,'research#5#333445555############'),
(0,738,'producty#2#sugarland############'),
(0,738,'computerization#10#stafford############'),
(0,783,'productx#1#bellaire#5###########'),
(0,783,'computerization#10#stafford#4###########'),
(0,800,'reorganization##############'),
(0,800,'computerization#vpn#4#400###########'),
(0,800,'computerization#open#20#100###########'),
(0,800,'newbenefits##############'),
(0,813,'10#computerization#6000#1000#380000##########'),
(0,813,'10#computerization#9000#2000#850000##########'),
(0,813,'10#computerization#61000#5000#516000##########'),
(0,813,'3#productz#16000#1000###########'),
(0,813,'20#reorganization#24000#3000#417000##########'),
(0,826,'1#1#500############'),
(0,826,'2#2#2200############'),
(0,826,'10#1#400############'),
(0,833,'3#productz#houston#research###########'),
(0,857,'1#productx#bellaire############'),
(0,857,'3#productz#houston############'),
(0,857,'20#reorganization#houston############'),
(0,857,'30#newbenefits#stafford############'),
(0,861,'123456789#alice#f#1988-12-30###########'),
(0,861,'123456789#michael#m#1988-01-04###########'),
(0,861,'987654321#jennifer#f#1941-06-20###########'),
(0,861,'987987987#ahmad#m#1969-03-29###########'),
(0,861,'999887777#alicia#f#1968-01-19###########'),
(19,200,'2#datastoragemanagement#############'),
(19,200,'2#datavisualization#############'),
(19,200,'2#xxxxastronomicaldata#############'),
(19,200,'2#xxxxautomateddatacorrelation#############'),
(19,200,'30#datastoragemanagement#############'),
(19,200,'30#datavisualization#############'),
(19,209,'anytimeanywherecrypto#houston#619000############'),
(19,209,'power,water&copper#dallas#############'),
(19,209,'#houston#850000############'),
(19,209,'thirdnationalbank#dallas#500000############'),
(19,227,'bank2#tempestbank#atlanta#200000###########'),
(19,227,'bank3#creditunionuniversal#newyork#417000###########'),
(19,227,'ebank1xxxx#fourthnationalbank#miami#600000###########'),
(19,227,'mgmt1#power,water&copper#dallas############'),
(19,227,'tech2#cumuluscloudcomputing##380000###########'),
(19,227,'tech3##houston#850000###########'),
(19,227,'xxxx2#thirdnationalbank#dallas#500000###########'),
...
(19,350,'10#vpn#1600############'),
(19,350,'10#open#2000############'),
(19,355,'123456789#3#1988-12-30############'),
(19,355,'333445555#3#1986-04-04############'),
(19,355,'987654321#1#1942-02-28############'),
(19,355,'999887777#1#2010-01-01############'),
(19,361,'#380000#1############'),
...
(19,409,'30#3#55.0############'),
(19,409,'41#3#297.0############'),
(19,441,'123456789#alice#7#1###########'),
(19,441,'123456789#michael#6#2###########'),
(19,441,'333445555#alice#10#0###########'),
(19,441,'999887777#xxxxaurora#9#0###########'),
(19,500,'john#smith#123456789#michael#731fondren,houstontx#m#########'),
(19,500,'franklin#wong#333445555#theodore#638voss,houstontx#m#########'),
(19,500,'alicia#zelaya#999887777#xxxxaurora#3321castle,springtx#f#########'),
(19,515,'administration#6#64000############'),
